...
export const shopProducts = [
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'The Al Noor Abaya is a study in quiet luxury — crafted from fluid crepe with a relaxed open-front silhouette. Designed for the woman who moves through the world with intention, it layers effortlessly over any ensemble.',
    details: {
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'Relaxed tailoring meets refined ease. The Zara Linen Co-ord is woven from pure linen for breathable all-day comfort — a considered set for the modern modest wardrobe.',
    details: {
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'Conceived for celebration, the Nadia Occasion Dress is draped in silk-blend chiffon with delicate embroidered detailing at the cuffs. Fluid, luminous, and effortlessly elegant.',
    details: {
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'The Sofiya Modest Dress is a wardrobe anchor — understated in form, exceptional in feel. Cut from our signature matte jersey for a smooth, non-clingy drape that moves beautifully.',
    details: {
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'Reserved for evenings that deserve something exceptional. The Hana Evening Abaya is rendered in premium satin-back crepe — a fabric that holds its form through the night while retaining an ethereal luminosity.',
    details: {
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description:
      'The Leila Wrap Dress is your daily companion — a forgiving wrap silhouette in soft viscose that flatters every form. Modest without compromise, effortless without effort.',
    details: {
